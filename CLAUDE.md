...
| `BGE_M3_MODEL` | `fp32` | Model variant: `fp32` = `BAAI/bge-m3` (~2.16 GB/session); `fp16` = `Xenova/bge-m3` (~1.08 GB/session). FP16 recommended for Apple Silicon to halve peak memory. |
